        ...
        for (i = 0; i < employeesArray.length; i++) {
            if (employeesArray[i].getClass() == employee.getClass()
                ...
                if (employee instanceof Developer) {
                    Developer developer = (Developer) employeesArray[i];
                    developer.fixedBugs = ((Developer) employee).fixedBugs;
                } else if (employee instanceof Cleaner) {
                    Cleaner cleaner = (Cleaner) employeesArray[i];
                    cleaner.workedDays = ((Cleaner) employee).workedDays;
                    cleaner.rate = ((Cleaner) employee).rate;
                }
