...
public class EmploeeService {
    ...
    void generateEmployees(int size) {
        ...
        for (int i = 0; i < employeesArray.length; i++) {
            ...
            if (employeeType == 'd') {
                com.stroganova.tasks.employeeservice.Developer developer = new com.stroganova.tasks.employeeservice.Developer();
                ...
                com.stroganova.tasks.employeeservice.Cleaner cleaner = new com.stroganova.tasks.employeeservice.Cleaner();
    ...
    Employee edit(Employee employee) {
        ...
        for (i = 0; i < employeesArray.length; i++) {
            if (employeesArray[i].getClass() == employee.getClass()
                ...
                if (employee instanceof com.stroganova.tasks.employeeservice.Developer) {
                    com.stroganova.tasks.employeeservice.Developer developer = (com.stroganova.tasks.employeeservice.Developer) employeesArray[i];
                    developer.fixedBugs = ((com.stroganova.tasks.employeeservice.Developer) employee).fixedBugs;
                } else if (employee instanceof com.stroganova.tasks.employeeservice.Cleaner) {
                    com.stroganova.tasks.employeeservice.Cleaner cleaner = (com.stroganova.tasks.employeeservice.Cleaner) employeesArray[i];
                    cleaner.workedDays = ((com.stroganova.tasks.employeeservice.Cleaner) employee).workedDays;
                    cleaner.rate = ((com.stroganova.tasks.employeeservice.Cleaner) employee).rate;
                }
